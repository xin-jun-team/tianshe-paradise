...
(function () {
  var searchData = [
    ...
    { title:'天赦魔核', path:'pages/feature-soul-core.html', keywords:'天赦魔核 碎片 合成 核心材料 soul core 35% 成功率' },
    ...
    { title:'每日任務', path:'pages/feature-daily-quest.html', keywords:'每日任務 天赦禮盒 天赦棒棒糖 兌換 騎士洞穴 古魯丁 龍之谷 精靈墓穴 地底湖 烽火戰場 支配之塔 夢幻之島 遺忘之島' },
    ...
    { title:'在線獎勵', path:'pages/feature-online-reward.html', keywords:'在線 福袋 獎勵 經驗藥水 變身卡 娃娃卡 天赦鑽 紅利幣' },
    ...
    { title:'累計贊助禮包', path:'pages/event-sponsor-gift.html', keywords:'贊助 禮包 累計 天赦同歡慶 天赦崛起 天赦征途 天赦霸主 天赦之父 天赦至尊 傳說變身 傳說娃娃' },
    ...
    { title:'首儲贈送', path:'pages/event-first-sponsor.html', keywords:'首儲 首次贊助 天赦魔核 變身卡寶箱' },
  ...
  overlay.innerHTML =
    ...
    '<div class="search-overlay__box">' + '<div class="search-overlay__label">◈ 天赦天堂 · 全站搜尋</div>' +
